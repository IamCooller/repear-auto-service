...
const Label = ({
  ...
  return (
    <div
      className={clsx('rounded-full px-1.5 border shadow-[0_0_1px_3px_black]', {
...
const Boundary = ({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black/40">
      <div
        className={clsx(
          'relative  rounded-lg border max-w-xl m-auto border-dashed bg-white',
          {
      ...
      >
        <div
          className={clsx(
            'absolute -top-2.5 text-blue-dark flex gap-x-1 text-[9px] uppercase leading-4 tracking-widest',
            {
